...
class FileUploadsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create file_upload" do
    assert_difference('FileUpload.count') do
      post file_uploads_url, params: { file_upload: { active_status: @file_upload.active_status, del_status: @file_upload.del_status, file_name: @file_upload.file_name, file_path: @file_upload.file_path, user_id: @file_upload.user_id } }
    end
  ...
  test "should update file_upload" do
    patch file_upload_url(@file_upload), params: { file_upload: { active_status: @file_upload.active_status, del_status: @file_upload.del_status, file_name: @file_upload.file_name, file_path: @file_upload.file_path, user_id: @file_upload.user_id } }
